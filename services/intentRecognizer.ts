...
export interface Intent {
  type: 'direct_query' | 'analysis' | 'report' | 'other';
 ...
 */
function isDirectTableQuery(input: string): boolean {
 ...
 */
function extractTableInfo(input: string): { table?: string; limit?: number } {
  const result: { table?: string; limit?: number } = {};
