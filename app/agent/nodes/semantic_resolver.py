...
def semantic_resolver_node(state: AgentState) -> Dict[str, Any]:
    ...
    _SEMANTIC_CACHE_VERSION = "v19"  # v18: 移除 semi:Inventory 类，统一 MaterialBatch 为唯一 warehouse_inventory 映射类；storedAtLocation→locatedAt，batchOfMaterial，hasStockQty 迁移至 MaterialBatch
